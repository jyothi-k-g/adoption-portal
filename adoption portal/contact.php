...
<nav class="navbar navbar-custom navbar-expand-lg navbar-light sticky-top" style="color: red;">
    ...
    <div class="contaniner">
        ...
        <div>
            ...
            <input type="text" name="PetName" class="form-control" id="inputPetName" placeholder="Enter Pet Name">
        </div>
        <div>
            <label for="inputBreed" class="form-label">Breed</label>
            <input type="text" name="Breed" class="form-control" id="inputBreed" placeholder="Enter Breed">
        </div>
        <div>
...
<?php
    if((isset($_POST['submit']))){
      ...
      $phone = $_POST["Phone"];
        ...
        $sql="INSERT INTO responses_form (Name, PetName, Breed, Email, Phone) VALUES ('".$name."','".$petname."', '".$breed."', '".$email."','".$phone."')";
